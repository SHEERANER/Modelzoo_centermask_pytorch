...
echo "TrainAccuracyBBox = ${train_accuracy_bbox}" >> ${test_path_dir}/output/$ASCEND_DEVICE_ID/${CaseName}.log
echo "TrainAccuracySgem = ${train_accuracy_sgem}" >> ${test_path_dir}/output/$ASCEND_DEVICE_ID/${CaseName}.log
